window.quizData = {
  config: {
  "title": "📜 History Buff",
  "subtitle": "10 random history questions. Different challenge every time.",
  "completionTitle": "📜 History Challenge Complete!",
  "times": {
    "easy": 10,
    "medium": 12,
    "hard": 15
  ...
  "ranks": [
    {
      "min": 100,
      "text": "🏛️ Historian Supreme! The archives have nothing on you."
    },
    {
      "min": 90,
      "text": "📚 History Scholar! Extremely impressive."
    },
    {
      "min": 80,
      "text": "🧠 History Buff confirmed. You know your eras."
    },
    {
      "min": 70,
      "text": "⚔️ Strong performance! A few empires managed to escape you."
    },
    {
      "min": 60,
      "text": "📜 Solid knowledge! You'd survive a history debate."
    },
    {
      "min": 50,
      "text": "🤔 Respectable! The past still has a few secrets."
    },
    {
      "min": 30,
      "text": "😅 History fought back a little harder than expected."
    },
    {
      "min": 0,
      "text": "😂 The past defeated you this round. Time for a historical rematch."
    }
  ]
},
  questions: [
